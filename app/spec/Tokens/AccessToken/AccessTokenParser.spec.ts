...
import {IPjmtAccessTokenContent} from '../../../src/Tokens/AccessToken/IPjmtAccessTokenContent';
...
describe('AccessTokenParser', () => {
  ...
  it('should parse a token', () => {
    ...
    let client_id = tokenParsed.conteudoObject<IPjmtAccessTokenContent>().client_id;
