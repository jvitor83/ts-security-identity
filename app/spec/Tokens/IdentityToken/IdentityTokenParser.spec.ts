...
import {PjmtIdentityTokenDecoded} from '../../../src/Tokens/IdentityToken/PjmtIdentityTokenDecoded';
...
describe('IdentityTokenParser', () => {
  ...
  it('should parse a token', () => {
    ...
    let tokenDecoded = tokenDecoder.Decode<PjmtIdentityTokenDecoded>(PjmtIdentityTokenDecoded);
    
    let sid = tokenDecoded.conteudoObject.sid;
