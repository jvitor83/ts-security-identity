...
import {SecurityContextEncodedTokenInitializer} from '../src/SecurityContextEncodedTokenInitializer';
...
describe('SecurityContext', () => {
  ...
  beforeEach(() => {
    ...
    it('Init should instantiate a User', () => {
        ...
        let securityContextInitializer = new SecurityContextEncodedTokenInitializer([accessToken, identityToken]);
    ...
    it('Should let a Customized Identity be set', () => {
        ...
        class IdentityCustomized extends Identity
        {
            ...
            {
                let value = this.findFirst<string>('client_id');
                return value;
            }
        }
        ...
        let customizedIdentity :IdentityCustomized = new IdentityCustomized([{ key: 'client_id', value: '2380' }]);
        SecurityContext.Current.Principal.Identity = customizedIdentity;
